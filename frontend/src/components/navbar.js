...
return ( 
<div class="w-full h-32 flex flex-row justify-between items-center "  >
   
<div class="w-44 h-20 flex flex-row justify-between items-center">
...
<div class="w-23 h-20 flex flex-row justify-around items-center ">
    <a href="">
