...
const Content  = () => {
    ...
    <div class="w-3/5 h-32 flex flex-col items-center justify-between">
    ...
    <div class="w-full h-32 rounded-2xl flex flex-row items-center relative border-none ">
<a class="z-10" href="">
    ...
    <input placeholder="Search" type="text" class="w-full h-14 rounded-2xl pl-12 absolute text-2xl placeholder-secondarycolor dark:placeholder-primarycolor text-secondarycolor dark:text-primarycolor  outline-none  bg-primarycolor dark:bg-secondarycolor border-2 focus:border-1 focus:rounded-0 ">
