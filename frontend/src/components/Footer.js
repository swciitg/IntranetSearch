...
import img3 from "../images_2/footer.svg"
import insta from "../images_2/insta.svg"
import linkdien from "../images_2/Vector.svg"
import twitter from "../images_2/twitter.svg"
const Footer=()=>{
    return(
        <div class="w-full bg-[#000000] h-20 flex absolute bottom-0 mt-4 -mb-28">
        
        <div class="w-1/5 h-full bg-inherit flex flex-col justify-center mx-4" >
          <p class="text-white w-full h-fit bg-inherit text-sm">© 2024 SWC, IITG</p>
        ...
        <div class="w-3/5 h-full bg-inherit flex items-center justify-center">
          <p class="text-white w-3/4 h-fit bg-inherit text-center">Crafted with care by Students' Web Committee, IITG</p>
        </div>
