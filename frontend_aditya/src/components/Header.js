...
import img1 from "../images/swc.svg"
import img2 from "../images/iitg.svg"
  ...
  const handleInputChange = (event) => {
    ...
    return(
        ...
        <div class="ml-8 w-9/12 h-28 flex items-center justify-center lg:justify-start">
          <input class="h-1/2 w-10/12 xsm:w-3/4 px-5  shadow-md hover:shadow-yellow-200/50 searchBar " type="text" placeholder='Search'  onChange={handleInputChange}></input>
        </div>


        <h3 class="mr-2 font-bold text-xs xsm:text-xl w-1/12 h-auto hover:cursor-pointer">d.aditya</h3>
